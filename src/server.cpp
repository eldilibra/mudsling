...
class web_server : public server_http
{
    ...
    )
    {
        ...
        */
        ...
        /*
        sout << "<html><head><title>Mudsling</title></head><body>"
            << "<h1>Welcome to Mudsling, traveler. Expect to be tested.</h1>"
            << "</body></html>";
        */
        sout << "Welcome to Mudsling, traveler. Expect to be tested.";
        return sout.str();
    }
...
int main()
{
    try
    {
        ...
        web_server mudsling_server;

        // make it listen on port 5000
        mudsling_server.set_listening_port(5000);
        // Tell the server to begin accepting connections.
        mudsling_server.start_async();
